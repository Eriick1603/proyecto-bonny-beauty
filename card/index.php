    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">Bonny Beauty</a>
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">Bonny Beauty</h1>
                <p class="lead fw-normal text-white-50 mb-0">Beauty shop</p>
            </div>
        </div>
    </header>
    <section class="py-5">
                            ...
                            <div class="card h-100">
                                ...
                                <div class="card-body p-4">
                                    <div class="text-center">
                                        ...
                                        <!-- Product price-->
                                        <?php
                                        if ($data['precio_rebajado'] === $data['precio_normal']) {
                                            echo '<span class="text-muted">' . $data['precio_rebajado'] . '</span>';
                                        } else {
                                            echo '<span class="text-muted text-decoration-line-through">' . $data['precio_normal'] . '</span>';
                                            echo $data['precio_rebajado'];
                                        }
                                        ?>
